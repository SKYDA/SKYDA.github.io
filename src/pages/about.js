        ...
        <div className='w-full flex justify-center font-Bai'>
            <div className='md:w-2/3 px-12 py-6 text-xl'>
                <div className='md:w-1/3 mx-auto border-2 border-black rounded-2xl my-3'>
                    <Image src='/images/msg407149974-38451.jpg' width='400' height='400' layout='responsive' alt='profile image' className='rounded-xl' />
                </div>
                <h3>Hi there, my name is <span className='font-semibold text-gray-700'>zhang</span>, and i am a frontend developer mostly passionate about react, next js and react native. loving the minimalistic ui ? yes, me too. i use tailwind css to do most of the css heavy lifting for me. </h3>
