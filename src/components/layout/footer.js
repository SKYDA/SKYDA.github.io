        ...
        <footer className=" flex flex-col items-center bg-black w-full space-x-2 py-10 md:px-12 px-4 mt-8 text-white font-Rubik bottom-0 ">
            <div className="md:flex w-full">
                <div className="md:w-1/5 text-center ">
                    <span className="font-Bai font-extrabold text-2xl"><Link href='/' >FE</Link></span>
                    <div className="flex align-baseline">
                        <h3 className="font-light text-xl mt-2 md:mt-5 text-gray-300 mx-auto ">FE interview question</h3>
                    </div>
                </div>
            ...
            <div className="text-center mt-4">
                <h2 className="text-gray-500 text-base ">© 2024</h2>
            </div>
        </footer>
    )
}
